  ...
  return (
    <StyledFormLayout>
      ...
      <StyledForm>
        ...
        <StyledFlexWrap>
          <StyledInput name={"email"} placeholder="Email" onChange={handleUserDataChange} onBlur={handleEmailToast}/>
          <BlueBtn>Email 인증</BlueBtn>
        </StyledFlexWrap>
        <StyledInput name={"nickname"} placeholder="닉네임" $mb onChange={handleUserDataChange} onBlur={handleNicknameToast}/>
        <StyledInput name={"password"} placeholder="비밀번호" type="password" $mb onChange={handleUserDataChange} onBlur={handlePasswordToast}/>
        <BirthWrap>
        ...
        <StyledBtn $fullWidth onClick={handleSignup}>가입하기</StyledBtn>
